...
- 📷 **Camera Integration** - Take photos of contracts directly from the camera
- 🖼️ **Gallery Picker** - Select files from device gallery
- 📤 **Native Share** - Share downloaded files with other apps
- 📁 **File System Access** - Access and store files on device
...
- Click the **📤 Share** button next to any file download
...
- ✅ **WRITE_EXTERNAL_STORAGE** - For saving files (Android ≤12)
